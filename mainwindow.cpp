...
/*
    ...
    /*
    if (ui-> radio_book->isChecked())
    {
        c=10;
    }
    if (ui->radio_ani->isChecked())
    {
        QMessageBox::information(this);
    }
    if(ui->radio_art->isChecked())
    {
        QMessageBox::information(this);
    }
    if(ui->radio_bg->isChecked())
    {
        QMessageBox::information(this, ,);
    }
    if(ui->radio_cel->isChecked())
    {
        QMessageBox::information(this, ,);
    }
    if(ui->radio_com->isChecked())
    {
        QMessageBox::information(this, ,);
    }
    if(ui->radio_com_2->isChecked())
    {
        QMessageBox::information(this, ,);
    }
    if(ui->radio_film->isChecked())
    {
        QMessageBox::information(this, ,);
    }
    if(ui->radio_gad->isChecked())
    {
        QMessageBox::information(this, ,);
    }
    if(ui->radio_geo->isChecked())
    {
        QMessageBox::information(this, ,);
    }
    if(ui->radio_his->isChecked())
    {
        QMessageBox::information(this, ,);
    }
    if(ui->radio_kno->isChecked())
    {
        QMessageBox::information(this, ,);
    }
    if(ui->radio_man->isChecked())
    {
        QMessageBox::information(this, ,);
    }
    if(ui->radio_math->isChecked())
    {
        QMessageBox::information(this, ,);
    }
    if(ui->radio_mus->isChecked())
    {
        QMessageBox::information(this, ,);
    }
    if(ui->radio_my->isChecked())
    {
        QMessageBox::information(this, ,);
    }
    if(ui->radio_pol->isChecked())
    {
        QMessageBox::information(this, ,);
    }
    if(ui->radio_sc->isChecked())
    {
        QMessageBox::information(this, ,);
    }
    if(ui->radio_sport->isChecked())
    {
        QMessageBox::information(this, ,);
    }
    if(ui->radio_tele->isChecked())
    {
        QMessageBox::information(this, ,);
    }
    if(ui->radio_the->isChecked())
    {
        QMessageBox::information(this, ,);
    }
    if(ui->radio_veh->isChecked())
    {
        QMessageBox::information(this, ,);
    }
    if(ui->radio_vg->isChecked())
    {
        QMessageBox::information(this, ,);
    }
